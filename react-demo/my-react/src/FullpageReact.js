...
require('./fullpageStyle/normalize.css');
require('./fullpageStyle/skeleton.css');
require('./fullpageStyle/exampleStyles.styl');
...
class FullpageReact extends React.Component {
    ...
    render() {
        ...
        const verticalSlides = [
            ...
            <Slide style={{backgroundColor: 'pink'}}><p>Slide 4</p></Slide>,
            <Slide style={{backgroundColor: 'pink'}}><p>Slide 5</p></Slide>,
        ];
